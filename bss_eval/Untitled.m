...
fs=16000;
s_1=audioread('C:\Users\chen\Desktop\array\female_16k_10s.wav'); % 原始
s_2=audioread('C:\Users\chen\Desktop\array\male_16k_10s.wav');
s=[s_1(1:fs*4).'/max(abs(s_1(1:fs*4)));s_2(1:fs*4).'/max(abs(s_2(1:fs*4)))];

se_1 = audioread('C:\Users\chen\Desktop\array\MVDR_sep21.wav'); % 分離
se_2 = audioread('C:\Users\chen\Desktop\array\MVDR_sep22.wav');
